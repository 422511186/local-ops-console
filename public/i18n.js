...
const ENGLISH = new Map(Object.entries({
  ...
  "关闭无端口访问后可修改": "Disable portless access before changing this port",
  "Caddy 内部端口必须是 1024-65535 之间的整数": "The Caddy internal port must be an integer between 1024 and 65535",
  "Caddy 内部端口已更新": "Caddy internal port updated",
  "保存": "Save",
  "系统转发规则与 Caddy 内部端口不一致，请重新授权同步。": "The system forwarding rule does not match the Caddy internal port. Authorize again to synchronize it.",
  ...
  "请先启动本机 Docker Engine，就绪后列表会自动刷新。": "Start the local Docker Engine; the list refreshes once it is ready.",
  "请先安装 Docker CLI 并确保其在 PATH 中，再重新打开 Local Ops。": "Install the Docker CLI on PATH, then reopen Local Ops.",
  "容器": "Container",
  "镜像": "Image",
  "端口": "Ports",
