...
This guide applies to Local Ops v1.9.0 on Apple Silicon (`arm64`) and Intel (`x64`) macOS.

## 1. Install, update, and open

### Install

1. Download `Local-Ops-1.9.0-arm64.dmg` (Apple Silicon) or `Local-Ops-1.9.0-x64.dmg` (Intel) from GitHub Releases.
